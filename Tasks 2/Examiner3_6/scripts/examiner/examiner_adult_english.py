...
sessionConfig = lavatask.base.SessionConfig("Configure Examiner Battery Session")
...
if myDlg.OK==True: #correct place for breakpoint for not hanging on flanker test
