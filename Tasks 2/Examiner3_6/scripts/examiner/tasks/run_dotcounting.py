...
"""Script example for running the Dot Counting Task
    
  Provides example of loading configuration file and running the Dot Counting Task   
...
sessionConfig = lavatask.base.SessionConfig("Configure Dot Counting Session")
if(not sessionConfig.getSessionConfig()):
    core.quit()
#Setup default task execution data
task = examiner.dotcounting.DotCountingTask(config,environment,sessionConfig)
